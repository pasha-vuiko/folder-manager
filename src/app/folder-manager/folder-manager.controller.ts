...
export class FolderManagerController {
    constructor(private folderManagerService: FolderManagerService, private loggerService: LoggerService) {
    }
    ...
    public executeCommand(commandStr: string): void {
        ...
        this.loggerService.logCommand(command as CommandsEnum, commandParams.join(' '));
